...
const html = readFileSync(`${SP}/groundwork-readiness.html`, 'utf8');
...
await p.pdf({
  path: `${SP}/Groundwork-15-Project-Readiness.pdf`,
  format: 'A4',
  ...
  footerTemplate:
    ...
    + '<span>Groundwork · fifteen-project readiness · 11 September 2026</span>'
