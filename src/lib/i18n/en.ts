...
export const en = {
  ...
  dashboard: {
    ...
    costCats: {
      materials: { label: 'Materials',             desc: 'Cement, blocks, rebar, fittings'     },
      labor:     { label: 'Labour',                desc: 'Site workers and supervision'        },
      fees:      { label: 'Professional Fees',     desc: 'Architects, engineers, project mgmt' },
      permits:   { label: 'Permits & contingency', desc: 'Government approvals and reserve'    },
    },
    empty: {
