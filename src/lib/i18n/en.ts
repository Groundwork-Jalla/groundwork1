...
export const en = {
  ...
  admin: {
    ...
    crm: {
      ...
      mailTestHint:      'Writes one note to your own contact through the same code the real emails use. Nothing is emailed, and no contractor is touched.',
      mailTestOk:        'The note was written. Emails are reaching contact timelines.',
      mailTestFailed:    'The note was not written, so emails are not reaching contact timelines.',
