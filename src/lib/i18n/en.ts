...
export const en = {
  ...
  toolsPage: {
    freeTitle:        'Free Planning Tools',
    wantFullPicture:  'Want the full picture?',
    stagePlanner:     'Construction Stage Planner',
    typicalDuration:  'Typical Duration',
    budgetAllocation: 'Budget Allocation',
    paymentTiming:    'Payment Timing',
    buildingSoon:     'Building soon?',
    diyTracker:       'DIY Project Tracker',
    projectName:      'Project Name',
    projectNamePlaceholder: 'My House Build',
