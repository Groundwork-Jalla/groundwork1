  ...
  project: {
    ...
    costing: {
      ...
      derive: {
        ...
        professional:      '{rate} XAF × {stages} stages',
        professionalNote:  'Flat. It does not grow with your budget, and it is billed as its own line rather than inside a stage.',
