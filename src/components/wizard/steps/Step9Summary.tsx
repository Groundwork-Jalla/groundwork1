  ...
  const tiers: TierCardProps[] = [
    {
      ...
      selected:    data.tier === 'starter',
      onSelect:    () => update({ tier: 'starter' }),
    },
    {
      value:       'pro',
      title:       'Pro',
      price:       '$19 / mo',
      description: 'Unlimited projects, full contractor access, and Jalla admin review on every stage.',
      features:    ['Unlimited projects', 'Full contractor directory', 'Admin stage review', 'Chat with Jalla'],
      selected:    data.tier === 'pro',
    ...
    },
    {
      ...
      features:    ['Everything in Pro', 'Dedicated project manager', 'Procurement oversight', 'On-site representation'],
      selected:    data.tier === 'enterprise',
      onSelect:    () => update({ tier: 'enterprise' }),
    },
  ];
