...
// `/community` is deliberately absent: the community page is hidden for now and
// its route redirects to sign-up, so listing it here would be a link to a redirect.
