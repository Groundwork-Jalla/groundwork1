    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6">
      ...
      >
        ...
        <div className="inline-flex items-center gap-2 rounded-full border border-brand-border-grey bg-brand-off-white px-3 py-1.5 mb-6">
          ...
          <span className="text-xs font-medium text-brand-near-black truncate max-w-[200px]">
            {invite.project_name}
          </span>
        </div>
        ...
        <p className="text-xs text-brand-mid-grey mb-8">
          Invite sent to <span className="text-brand-near-black">{invite.invite_email}</span>
        </p>

        <p className="text-xs text-brand-mid-grey mb-5 leading-relaxed">
